    ...
    return (
        <form onSubmit={handleCreateUser}>
            <div className="form-group">
                ...
                <small id="nameHelp" class="form-text text-muted">Name must be at least 5 character</small>
            </div>
            <div className="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Enter a valid mail(gmail,yahoo,email,info)</small>
            </div>
            <div className="form-group">
                ...
                <small id="passHelp" class="form-text text-muted">Password must be at least 6 character with number, uppercase, lowercase</small>
            </div>
            <div className="form-group">
